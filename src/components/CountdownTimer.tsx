...
const CountdownTimer = () => {
  ...
  return (
    <div className="bg-primary py-2 px-4 flex flex-col items-center">
      <b className="text-primary-foreground text-xs mb-1">A promoção vai acabar em:</b>
      <div className="flex items-center gap-5">
        <div className="flex flex-col items-center">
          <span className="bg-[hsl(356_78%_44%)] text-primary-foreground font-semibold text-base px-3 py-1 rounded-md min-w-[50px] text-center">
